import React from 'react'
 ...
 import profileImage from '../../assets/Profile/Mukul_logo.png'
const About = () => {
  return (
    <section id='about'
      ...
      <div className='md:w-1/2 text-center md:text-left mt-8 md:mt-0'>
           ...
           <h2 className='text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 leading-tight'>
            ...
            ></ReactTypingEffect>
              ...
              {/* Resume Button */}
              <a href="https://drive.google.com/file/d/1E8WVzOhxinBHMQtyuk720hH8H-_AJ8vI/view?usp=drive_link"
              target='_blank'
         ...
         {/*Right Side  */}
            ...
            gyroscope={true}
              >
               <img src={profileImage} alt="Mukul Rajput" 
